  ...
  "乐商贷": {
    ...
    navigationOptions: ({navigation, screenProps}) => ({
      ...
      tabBarIcon: (({tintColor, focused}) => {
        ...
        <Icon name={"ic_money"} size={px2dp(23)} color={focused
            ? '#ff0000'
            : '#555555'}/>)
      })
    })
  ...
  产品: {
    ...
    navigationOptions: ({navigation, screenProps}) => ({
      ...
      tabBarIcon: (({tintColor, focused}) => {
        ...
        <Icon name={"ic_list"} size={px2dp(23)} color={focused
            ? '#ff0000'
            : '#555555'}/>)
      })
    })
  ...
  我的: {
    ...
    navigationOptions: ({navigation, screenProps}) => ({
      ...
      tabBarIcon: (({tintColor, focused}) => {
        ...
        <Icon name={"ic_my"} size={px2dp(23)} color={focused
            ? '#ff0000'
            : '#555555'}/>)
      }),
      tabBarOnPress: ((obj) => {
        ...
        navigation.navigate('LoginPage', {'headerTitle': '登录'});
      })
    }),
  ...
  更多: {
    ...
    navigationOptions: ({navigation, screenProps}) => ({
      ...
      tabBarIcon: (({tintColor, focused}) => {
        ...
        <Icon name={"ic_more"} size={px2dp(23)} color={focused
            ? '#ff0000'
            : '#555555'}/>)
      })
    })
...
const MyApp = StackNavigator({
  ...
  ProductPage: {
    screen: ProductPage,
    navigationOptions: () => ({headerTintColor: '#999999'})
  },
  YSWebView: {
    screen: YSWebView,
    navigationOptions: () => ({headerTintColor: '#999999'})
